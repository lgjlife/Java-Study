...
- [1. 计算机&网络&操作系统](#1-计算机网络操作系统)
    ...
    - [1.2. 操作系统](#12-操作系统)
        - [1.2.1. 操作系统基本概念](#121-操作系统基本概念)
            ...
            - [1.2.1.5. Linux进程和线程的区别](#1215-linux进程和线程的区别)
    - [1.3. 网络TCP](#13-网络tcp)
    ...
    - [1.4. 网络HTTP](#14-网络http)
        ...
        - [1.4.5. HTTPS](#145-https)
            - [1.4.5.1. HTTP协议的缺点以及改进目标](#1451-http协议的缺点以及改进目标)
            - [1.4.5.2. 密码基础](#1452-密码基础)
            - [1.4.5.3. HTTPS协议的改进](#1453-https协议的改进)
            - [1.4.5.4. HTTPS实现原理](#1454-https实现原理)
            - [1.4.5.5. 与HTTP原理区别](#1455-与http原理区别)
            - [1.4.5.6. 优缺点](#1456-优缺点)
        - [1.4.6. WEB服务器](#146-web服务器)
        - [1.4.7. 代理](#147-代理)
        - [1.4.8. 缓存](#148-缓存)
        - [1.4.9. 网关](#149-网关)
        - [1.4.10. 客户端识别与Cookie机制](#1410-客户端识别与cookie机制)
        - [1.4.11. 基本认证机制](#1411-基本认证机制)
        - [1.4.12. 摘要认证](#1412-摘要认证)
        - [1.4.13. 安全HTTP](#1413-安全http)
        - [1.4.14. 实体和编码](#1414-实体和编码)
        - [1.4.15. 国际化](#1415-国际化)
        - [1.4.16. WEB主机托管](#1416-web主机托管)
        - [1.4.17. 重定向和负载均衡](#1417-重定向和负载均衡)
    - [1.5. WEB Socket](#15-web-socket)
        ...
        - [1.5.7. SpringBoot + WebSocket实现案例](#157-springboot--websocket实现案例)
            - [1.5.7.1. 第一种实现方法](#1571-第一种实现方法)
            - [1.5.7.2. 第二种实现方法](#1572-第二种实现方法)
            - [1.5.7.3. 补充说明](#1573-补充说明)
            - [1.5.7.4. 客户端的实现，js方式和java WebSocketClient两种方式](#1574-客户端的实现js方式和java-websocketclient两种方式)
...
### 1.5.7. SpringBoot + WebSocket实现案例
<a href="#menu" style="float:right">目录</a>
...
#### 1.5.7.4. 客户端的实现，js方式和java WebSocketClient两种方式
<a href="#menu" style="float:right">目录</a>
