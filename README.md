...
- [32. 设计模式](#32-设计模式)
    - [32.1. 设计原则](#321-设计原则)
        - [32.1.1. 单一职责原则](#3211-单一职责原则)
        - [32.1.2. 里氏替换原则](#3212-里氏替换原则)
        - [32.1.3. 依赖倒置原则](#3213-依赖倒置原则)
        - [32.1.4. 接口隔离原则](#3214-接口隔离原则)
        - [32.1.5. 迪米特法则](#3215-迪米特法则)
        - [32.1.6. 开闭原则](#3216-开闭原则)
    - [32.2. UML图](#322-uml图)
    - [32.3. 单例模式](#323-单例模式)
        - [32.3.1. 基本概念](#3231-基本概念)
        - [32.3.2. 实现](#3232-实现)
    - [32.4. 工厂方法模式](#324-工厂方法模式)
    - [32.5. 抽象工厂模式](#325-抽象工厂模式)
    - [32.6. 模板方法模式](#326-模板方法模式)
    - [32.7. 建造者模式](#327-建造者模式)
    - [32.8. 代理模式](#328-代理模式)
    - [32.9. 原型模式](#329-原型模式)
    - [32.10. 中介者模式](#3210-中介者模式)
    - [32.11. 命令模式](#3211-命令模式)
    - [32.12. 责任链模式](#3212-责任链模式)
    - [32.13. 装饰模式](#3213-装饰模式)
    - [32.14. 策略模式](#3214-策略模式)
    - [32.15. 适配器模式](#3215-适配器模式)
    - [32.16. 迭代器模式](#3216-迭代器模式)
    - [32.17. 组合模式](#3217-组合模式)
    - [32.18. 观察者模式](#3218-观察者模式)
    - [32.19. 门面模式](#3219-门面模式)
    - [32.20. 备忘录模式](#3220-备忘录模式)
    - [32.21. 访问者模式](#3221-访问者模式)
    - [32.22. 状态模式](#3222-状态模式)
    - [32.23. 解释器模式](#3223-解释器模式)
    - [32.24. 享元模式](#3224-享元模式)
    - [32.25. 桥梁模式](#3225-桥梁模式)
- [33. Zookeeper](#33-zookeeper)
    - [33.1. 基本概念](#331-基本概念)
        - [33.1.1. zk架构](#3311-zk架构)
        - [33.1.2. 提供的功能](#3312-提供的功能)
        - [33.1.3. 节点类型](#3313-节点类型)
- [34. 登录认证](#34-登录认证)
    - [34.1. Shiro](#341-shiro)
    - [34.2. oauth2](#342-oauth2)
    - [34.3. token](#343-token)
- [35. 分布式系统&高并发](#35-分布式系统高并发)
    - [35.1. 基本概念](#351-基本概念)
    - [35.2. 架构演进](#352-架构演进)
    - [35.3. 序列化机制](#353-序列化机制)
        - [35.3.1. 基本概念](#3531-基本概念)
        - [35.3.2. 常用序列化方式性能比较](#3532-常用序列化方式性能比较)
        - [35.3.3. 常用序列化方式实现](#3533-常用序列化方式实现)
            - [35.3.3.1. JDK方式](#35331-jdk方式)
            - [35.3.3.2. FastJSON](#35332-fastjson)
            - [35.3.3.3. Hessian](#35333-hessian)
            - [35.3.3.4. Protostuff](#35334-protostuff)
    - [35.4. 定时任务](#354-定时任务)
    - [35.5. Cron表达式](#355-cron表达式)
        - [35.5.1. Spring Scheduler](#3551-spring-scheduler)
        - [35.5.2. Quartz](#3552-quartz)
            - [35.5.2.1. Quartz 核心概念](#35521-quartz-核心概念)
    - [35.6. 分布式ID](#356-分布式id)
        - [35.6.1. 应用场景](#3561-应用场景)
        - [35.6.2. 分布式ID生成方案](#3562-分布式id生成方案)
    - [35.7. 分布式锁](#357-分布式锁)
    - [35.8. 微服务化](#358-微服务化)
    - [35.9. 缓存](#359-缓存)
        - [35.9.1. 缓存一致性问题](#3591-缓存一致性问题)
    - [35.10. 消息机制](#3510-消息机制)
    - [35.11. 服务降级](#3511-服务降级)
    - [35.12. 流量限流](#3512-流量限流)
    - [35.13. 幂等设计](#3513-幂等设计)
    - [35.14. 数据一致性](#3514-数据一致性)
        - [35.14.1. CAP理论](#35141-cap理论)
        - [35.14.2. Base理论](#35142-base理论)
    - [35.15. 分布式事务实现](#3515-分布式事务实现)
    - [35.16. 负载均衡算法](#3516-负载均衡算法)
    - [35.17. 服务容错设计](#3517-服务容错设计)
    - [35.18. 集群](#3518-集群)
    - [35.19. 分库分表](#3519-分库分表)
    - [35.20. 反向代理&正向代理](#3520-反向代理正向代理)
    - [35.21. 客户端优化](#3521-客户端优化)
