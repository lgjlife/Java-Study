...
- [4. 操作系统](#4-操作系统)
    - [4.1. 操作系统基本概念](#41-操作系统基本概念)
            - [4.1.0.1. 操作系统发展过程](#4101-操作系统发展过程)
            - [4.1.0.2. 基本特性](#4102-基本特性)
- [5. 算法](#5-算法)
- [6. 网络TCP](#6-网络tcp)
    - [6.1. OSI网路分层](#61-osi网路分层)
    - [6.2. IP(Internet Protocol,网际协议)](#62-ipinternet-protocol网际协议)
        - [6.2.1. 基本概念](#621-基本概念)
        - [6.2.2. IP地址定义](#622-ip地址定义)
        - [6.2.3. IP协议相关技术](#623-ip协议相关技术)
            - [6.2.3.1. DNS](#6231-dns)
            - [6.2.3.2. ARP](#6232-arp)
    - [6.3. 传输层](#63-传输层)
        - [6.3.1. 基本概念](#631-基本概念)
            - [6.3.1.1. TCP和UDP差别](#6311-tcp和udp差别)
            - [6.3.1.2. 端口](#6312-端口)
        - [6.3.2. UDP](#632-udp)
        - [6.3.3. TCP](#633-tcp)
            - [6.3.3.1. 连接管理](#6331-连接管理)
            - [6.3.3.2. 超时重传机制](#6332-超时重传机制)
            - [6.3.3.3. 数据流和窗口机制](#6333-数据流和窗口机制)
            - [6.3.3.4. 阻塞控制](#6334-阻塞控制)
- [7. 网络HTTP](#7-网络http)
    - [7.1. 基本概念](#71-基本概念)
        - [7.1.1. 访问一个网站的流程](#711-访问一个网站的流程)
        - [7.1.2. 媒体类型(MIME)](#712-媒体类型mime)
    - [7.2. URL和资源](#72-url和资源)
    ...
    - [7.4. 连接管理](#74-连接管理)
        ...
        - [7.4.2. 持久连接](#742-持久连接)
    - [7.5. WEB服务器](#75-web服务器)
    - [7.6. 代理](#76-代理)
    - [7.7. 缓存](#77-缓存)
    - [7.8. 网关](#78-网关)
    - [7.9. 客户端识别与Cookie机制](#79-客户端识别与cookie机制)
    - [7.10. 基本认证机制](#710-基本认证机制)
    - [7.11. 摘要认证](#711-摘要认证)
    - [7.12. 安全HTTP](#712-安全http)
    - [7.13. 实体和编码](#713-实体和编码)
    - [7.14. 国际化](#714-国际化)
    - [7.15. WEB主机托管](#715-web主机托管)
    - [7.16. 重定向和负载均衡](#716-重定向和负载均衡)
- [8. Unix环境编程](#8-unix环境编程)
- [9. Shell](#9-shell)
    - [9.1. 文件相关](#91-文件相关)
    - [9.2. 系统监控](#92-系统监控)
    - [9.3. 处理数据文件](#93-处理数据文件)
    - [9.4. 环境变量](#94-环境变量)
    - [9.5. 基本脚本命令](#95-基本脚本命令)
    - [9.6. 结构化命令](#96-结构化命令)
    - [9.7. 处理用户输入](#97-处理用户输入)
    - [9.8. 控制脚本](#98-控制脚本)
- [10. Git](#10-git)
    - [10.1. 基本概念](#101-基本概念)
    - [10.2. 常用命令](#102-常用命令)
...
- [13. Docker](#13-docker)
    - [13.1. Docker常用指令](#131-docker常用指令)
- [14. Java基础](#14-java基础)
    - [14.1. 数据类型](#141-数据类型)
        - [14.1.1. 数据类型](#1411-数据类型)
        - [14.1.2. Integer 缓存对象](#1412-integer-缓存对象)
        - [14.1.3. 数组](#1413-数组)
        - [14.1.4. String](#1414-string)
    - [14.2. 面向对象](#142-面向对象)
        - [14.2.1. 三大特性](#1421-三大特性)
        - [14.2.2. 权限修饰符](#1422-权限修饰符)
        - [14.2.3. 接口和抽象类](#1423-接口和抽象类)
        - [14.2.4. 内部类](#1424-内部类)
        - [14.2.5. 枚举类](#1425-枚举类)
    - [14.3. 范型](#143-范型)
    - [14.4. 集合](#144-集合)
    ...
    - [14.8. 反射](#148-反射)
    - [14.9. JDBC](#149-jdbc)
- [15. JAVA Socket编程](#15-java-socket编程)
- [16. JAVA多线程](#16-java多线程)
    - [16.1. 基本概念](#161-基本概念)
    - [16.2. Java多线程](#162-java多线程)
        - [16.2.1. 实现方式](#1621-实现方式)
        - [16.2.2. 基本属性](#1622-基本属性)
        - [16.2.3. 常用方法](#1623-常用方法)
        - [16.2.4. 生命周期 & 线程状态](#1624-生命周期--线程状态)
        - [16.2.5. 线程监控工具](#1625-线程监控工具)
    - [16.3. Synchronized](#163-synchronized)
    - [16.4. Lock](#164-lock)
    - [16.5. 线程池](#165-线程池)
    - [16.6. 并发工具类](#166-并发工具类)
    - [16.7. 锁优化](#167-锁优化)
    - [16.8. 异步编程](#168-异步编程)
    - [16.9. Java内存模型](#169-java内存模型)
    - [16.10. volatile](#1610-volatile)
- [17. 测试](#17-测试)
    - [17.1. 基本测试](#171-基本测试)
    - [17.2. 控制层测试](#172-控制层测试)
    - [17.3. 服务层测试](#173-服务层测试)
    - [17.4. DAO层测试](#174-dao层测试)
- [18. JVM](#18-jvm)
- [19. MySQL](#19-mysql)
    - [19.1. 常用语句](#191-常用语句)
        - [19.1.1.](#1911)
...
- [23. Redis](#23-redis)
- [24. Spring](#24-spring)
- [25. SpringBoot](#25-springboot)
    - [25.1. 基本概念](#251-基本概念)
    - [25.2. Spring Boot 环境下创建Bean](#252-spring-boot-环境下创建bean)
- [26. SpringCloud](#26-springcloud)
- [27. Dubbo](#27-dubbo)
- [28. RocketMQ](#28-rocketmq)
- [29. RabbitMQ](#29-rabbitmq)
- [30. Kafka](#30-kafka)
- [31. Nginx](#31-nginx)
- [32. Tomcat](#32-tomcat)
- [33. elasticsearch](#33-elasticsearch)
- [34. FastDfs](#34-fastdfs)
- [35. 设计模式](#35-设计模式)
    - [35.1. 设计原则](#351-设计原则)
        - [35.1.1. 单一职责原则](#3511-单一职责原则)
        - [35.1.2. 里氏替换原则](#3512-里氏替换原则)
        - [35.1.3. 依赖倒置原则](#3513-依赖倒置原则)
        - [35.1.4. 接口隔离原则](#3514-接口隔离原则)
        - [35.1.5. 迪米特法则](#3515-迪米特法则)
        - [35.1.6. 开闭原则](#3516-开闭原则)
    - [35.2. UML图](#352-uml图)
    - [35.3. 单例模式](#353-单例模式)
        - [35.3.1. 基本概念](#3531-基本概念)
        - [35.3.2. 实现](#3532-实现)
    - [35.4. 工厂方法模式](#354-工厂方法模式)
    - [35.5. 抽象工厂模式](#355-抽象工厂模式)
    - [35.6. 模板方法模式](#356-模板方法模式)
    - [35.7. 建造者模式](#357-建造者模式)
    - [35.8. 代理模式](#358-代理模式)
    - [35.9. 原型模式](#359-原型模式)
    - [35.10. 中介者模式](#3510-中介者模式)
    - [35.11. 命令模式](#3511-命令模式)
    - [35.12. 责任链模式](#3512-责任链模式)
    - [35.13. 装饰模式](#3513-装饰模式)
    - [35.14. 策略模式](#3514-策略模式)
    - [35.15. 适配器模式](#3515-适配器模式)
    - [35.16. 迭代器模式](#3516-迭代器模式)
    - [35.17. 组合模式](#3517-组合模式)
    - [35.18. 观察者模式](#3518-观察者模式)
    - [35.19. 门面模式](#3519-门面模式)
    - [35.20. 备忘录模式](#3520-备忘录模式)
    - [35.21. 访问者模式](#3521-访问者模式)
    - [35.22. 状态模式](#3522-状态模式)
    - [35.23. 解释器模式](#3523-解释器模式)
    - [35.24. 享元模式](#3524-享元模式)
    - [35.25. 桥梁模式](#3525-桥梁模式)
- [36. Zookeeper](#36-zookeeper)
    - [36.1. 基本概念](#361-基本概念)
        - [36.1.1. zk架构](#3611-zk架构)
        - [36.1.2. 提供的功能](#3612-提供的功能)
        - [36.1.3. 节点类型](#3613-节点类型)
- [37. 登录认证](#37-登录认证)
    - [37.1. Shiro](#371-shiro)
    - [37.2. oauth2](#372-oauth2)
    - [37.3. token](#373-token)
- [38. 分布式系统&高并发](#38-分布式系统高并发)
    - [38.1. 基本概念](#381-基本概念)
    - [38.2. 大型网站的特点](#382-大型网站的特点)
        - [38.2.1. 特点](#3821-特点)
        - [38.2.2. 模式](#3822-模式)
    - [38.3. 架构演进](#383-架构演进)
    - [38.4. 序列化机制](#384-序列化机制)
        - [38.4.1. 基本概念](#3841-基本概念)
        - [38.4.2. 常用序列化方式性能比较](#3842-常用序列化方式性能比较)
        - [38.4.3. 常用序列化方式实现](#3843-常用序列化方式实现)
            - [38.4.3.1. JDK方式](#38431-jdk方式)
            - [38.4.3.2. FastJSON](#38432-fastjson)
            - [38.4.3.3. Hessian](#38433-hessian)
            - [38.4.3.4. Protostuff](#38434-protostuff)
    - [38.5. 定时任务](#385-定时任务)
    - [38.6. Cron表达式](#386-cron表达式)
        - [38.6.1. Spring Scheduler](#3861-spring-scheduler)
        - [38.6.2. Quartz](#3862-quartz)
            - [38.6.2.1. Quartz 核心概念](#38621-quartz-核心概念)
    - [38.7. 分布式ID](#387-分布式id)
        - [38.7.1. 应用场景](#3871-应用场景)
        - [38.7.2. 分布式ID生成方案](#3872-分布式id生成方案)
    - [38.8. 分布式锁](#388-分布式锁)
        - [38.8.1. 使用数据库实现](#3881-使用数据库实现)
        - [38.8.2. Redis实现分布式锁](#3882-redis实现分布式锁)
        - [38.8.3. Zookeeper实现分布式锁](#3883-zookeeper实现分布式锁)
    - [38.9. 微服务化](#389-微服务化)
    - [38.10. 缓存](#3810-缓存)
        - [38.10.1. 缓存一致性问题](#38101-缓存一致性问题)
    - [38.11. 消息机制](#3811-消息机制)
    - [38.12. 服务降级](#3812-服务降级)
    - [38.13. 流量限流](#3813-流量限流)
    - [38.14. 幂等设计](#3814-幂等设计)
    - [38.15. 数据一致性](#3815-数据一致性)
        - [38.15.1. CAP理论](#38151-cap理论)
        - [38.15.2. Base理论](#38152-base理论)
    - [38.16. 分布式事务实现](#3816-分布式事务实现)
    - [38.17. 负载均衡算法](#3817-负载均衡算法)
    - [38.18. 服务容错设计](#3818-服务容错设计)
    - [38.19. 集群](#3819-集群)
    - [38.20. 分库分表](#3820-分库分表)
    - [38.21. 反向代理&正向代理](#3821-反向代理正向代理)
    - [38.22. 客户端优化](#3822-客户端优化)
