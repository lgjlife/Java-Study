...
- [1. Java基础](#1-java基础)
    - [1.1. 数据类型](#11-数据类型-1)
        - [1.1.1. 数据类型](#111-数据类型)
        - [1.1.2. Integer 缓存对象](#112-integer-缓存对象)
        - [1.1.3. 数组](#113-数组)
        - [1.1.4. String](#114-string)
    - [1.2. 面向对象](#12-面向对象)
        - [1.2.1. 三大特性](#121-三大特性)
        - [1.2.2. 权限修饰符](#122-权限修饰符)
        - [1.2.3. 接口和抽象类](#123-接口和抽象类)
        - [1.2.4. 内部类](#124-内部类)
        - [1.2.5. 枚举类](#125-枚举类)
    - [1.3. 范型](#13-范型)
    - [1.4. 集合](#14-集合)
    ...
    - [1.8. 反射](#18-反射)
    - [1.9. JDBC](#19-jdbc)
- [2. JAVA Socket编程](#2-java-socket编程)
- [4. JDK版本变化](#4-jdk版本变化)
- [5. Java性能优化](#5-java性能优化)
    - [5.1. Java 性能调优概述](#51-java-性能调优概述)
        - [5.1.1. 性能概述](#511-性能概述)
        - [5.1.2. 性能调优的层次](#512-性能调优的层次)
    - [Java程序优化](#java程序优化)
        - [有助于改善性能的技巧](#有助于改善性能的技巧)
    - [设计优化](#设计优化)
        - [](#)
    - [5.2. JVM内存模型介绍](#52-jvm内存模型介绍)
        - [运行时数据区域](#运行时数据区域)
    - [5.3. 垃圾收集器和内存分配策略](#53-垃圾收集器和内存分配策略)
    - [5.4. 虚拟机性能监控和故障处理工具](#54-虚拟机性能监控和故障处理工具)
    - [5.5. 类文件结构](#55-类文件结构)
    - [5.6. 虚拟机类加载机制](#56-虚拟机类加载机制)
    - [5.7. 虚拟机字节码执行引擎](#57-虚拟机字节码执行引擎)
    - [5.8. 编译期优化](#58-编译期优化)
    - [5.9. 运行期优化](#59-运行期优化)
    - [5.10. Java内存模型与线程](#510-java内存模型与线程)
    - [5.11. 线程安全与锁优化](#511-线程安全与锁优化)
- [6. 设计模式](#6-设计模式)
    - [6.1. 设计原则](#61-设计原则)
        - [6.1.1. 单一职责原则](#611-单一职责原则)
        - [6.1.2. 里氏替换原则](#612-里氏替换原则)
        - [6.1.3. 依赖倒置原则](#613-依赖倒置原则)
        - [6.1.4. 接口隔离原则](#614-接口隔离原则)
        - [6.1.5. 迪米特法则](#615-迪米特法则)
        - [6.1.6. 开闭原则](#616-开闭原则)
    - [6.2. UML图](#62-uml图)
    - [6.3. 单例模式](#63-单例模式)
        - [6.3.1. 基本概念](#631-基本概念)
        - [6.3.2. 实现](#632-实现)
    - [6.4. 工厂方法模式](#64-工厂方法模式)
    - [6.5. 抽象工厂模式](#65-抽象工厂模式)
    - [6.6. 模板方法模式](#66-模板方法模式)
    - [6.7. 建造者模式](#67-建造者模式)
    - [6.8. 代理模式](#68-代理模式)
    - [6.9. 原型模式](#69-原型模式)
    - [6.10. 中介者模式](#610-中介者模式)
    - [6.11. 命令模式](#611-命令模式)
    - [6.12. 责任链模式](#612-责任链模式)
    - [6.13. 装饰模式](#613-装饰模式)
    - [6.14. 策略模式](#614-策略模式)
    - [6.15. 适配器模式](#615-适配器模式)
    - [6.16. 迭代器模式](#616-迭代器模式)
    - [6.17. 组合模式](#617-组合模式)
    - [6.18. 观察者模式](#618-观察者模式)
    - [6.19. 门面模式](#619-门面模式)
    - [6.20. 备忘录模式](#620-备忘录模式)
    - [6.21. 访问者模式](#621-访问者模式)
    - [6.22. 状态模式](#622-状态模式)
    - [6.23. 解释器模式](#623-解释器模式)
    - [6.24. 享元模式](#624-享元模式)
    - [6.25. 桥梁模式](#625-桥梁模式)
- [1. 基本概念](#1-基本概念)
- [2. Java多线程](#2-java多线程)
...
- [2. 负载均衡](#2-负载均衡)
    ...
    - [2.2. 硬件负载均衡](#22-硬件负载均衡)
    - [2.3. 四层和七层负载均衡的区别？](#23-四层和七层负载均衡的区别)
        - [2.3.1. 技术原理上的区别。](#231-技术原理上的区别)
        - [2.3.2. 应用场景的需求。](#232-应用场景的需求)
        - [2.3.3. 七层应用需要考虑的问题。](#233-七层应用需要考虑的问题)
    - [2.4. 负载均衡的算法](#24-负载均衡的算法)
        - [2.4.1. 随机算法](#241-随机算法)
        - [2.4.2. 轮询及加权轮询](#242-轮询及加权轮询)
        - [2.4.3. 最小连接及加权最小连接](#243-最小连接及加权最小连接)
        - [2.4.4. 哈希算法](#244-哈希算法)
        - [2.4.5. IP地址散列](#245-ip地址散列)
        - [2.4.6. URL散列](#246-url散列)
        - [2.4.7. 一致性哈希算法](#247-一致性哈希算法)
    - [2.5. 负载均衡的实现（DNS > 数据链路层 > IP层 > Http层）](#25-负载均衡的实现dns--数据链路层--ip层--http层)
        - [2.5.1. DNS域名解析负载均衡（延迟）](#251-dns域名解析负载均衡延迟)
        - [2.5.2. 数据链路层负载均衡(LVS)](#252-数据链路层负载均衡lvs)
        - [2.5.3. IP负载均衡(SNAT)](#253-ip负载均衡snat)
        - [2.5.4. HTTP重定向负载均衡(少见)](#254-http重定向负载均衡少见)
        - [2.5.5. 反向代理负载均衡(nginx)](#255-反向代理负载均衡nginx)
- [3. 隔离](#3-隔离)
    - [3.1. 概述](#31-概述)
- [4. 限流](#4-限流)
    - [4.1. 概述](#41-概述)
...
- [7. 回滚机制](#7-回滚机制)
    - [7.1. 事务回滚](#71-事务回滚)
    - [7.2. 代码库回滚](#72-代码库回滚)
    - [7.3. 部署版本回滚](#73-部署版本回滚)
    - [7.4. 静态资源回滚](#74-静态资源回滚)
- [8. 压测与预案](#8-压测与预案)
    - [8.1. 系统压测](#81-系统压测)
        - [8.1.1. 线下压测](#811-线下压测)
        - [8.1.2. 线上压测](#812-线上压测)
    - [8.2. 系统优化和容灾](#82-系统优化和容灾)
- [9. 缓存](#9-缓存)
    - [9.1. 应用级缓存](#91-应用级缓存)
        - [9.1.1. 缓存回收策略](#911-缓存回收策略)
        - [9.1.2. 回收算法](#912-回收算法)
            - [9.1.2.1. FIFO](#9121-fifo)
            - [9.1.2.2. LRU](#9122-lru)
            - [9.1.2.3. LFU](#9123-lfu)
            - [9.1.2.4. LRFU](#9124-lrfu)
        - [9.1.3. Java 缓存类型](#913-java-缓存类型)
            - [9.1.3.1. 堆缓存](#9131-堆缓存)
            - [9.1.3.2. 对外缓存](#9132-对外缓存)
            - [9.1.3.3. 磁盘缓存](#9133-磁盘缓存)
            - [9.1.3.4. 分布式缓存](#9134-分布式缓存)
            - [9.1.3.5. 多级缓存](#9135-多级缓存)
        - [9.1.4. 应用级缓存示例](#914-应用级缓存示例)
        - [9.1.5. 缓存使用模式实践](#915-缓存使用模式实践)
            - [9.1.5.1. Cache-Aside](#9151-cache-aside)
            - [9.1.5.2. Cache-As-SOR](#9152-cache-as-sor)
            - [9.1.5.3. Read-Through](#9153-read-through)
            - [9.1.5.4. Write-Through](#9154-write-through)
            - [9.1.5.5. Write-Behind](#9155-write-behind)
            - [9.1.5.6. Copy-Pattern](#9156-copy-pattern)
        - [9.1.6. 缓存一致性处理](#916-缓存一致性处理)
        - [9.1.7. 缓存异常处理](#917-缓存异常处理)
            - [9.1.7.1. 缓存穿透](#9171-缓存穿透)
            - [9.1.7.2. 缓存击穿](#9172-缓存击穿)
            - [9.1.7.3. 缓存雪崩](#9173-缓存雪崩)
            - [9.1.7.4. 解决方案](#9174-解决方案)
            - [9.1.7.5. 缓存并发问题](#9175-缓存并发问题)
    - [9.2. HTTP缓存](#92-http缓存)
        - [9.2.1. 浏览器缓存](#921-浏览器缓存)
        - [9.2.2. CDN缓存](#922-cdn缓存)
        - [9.2.3. NGINX缓存](#923-nginx缓存)
- [1. 分布式系统](#1-分布式系统)
    - [1.1. 基本概念](#11-基本概念)
    - [1.2. 大型网站的特点](#12-大型网站的特点)
        - [1.2.1. 特点](#121-特点)
        - [1.2.2. 模式](#122-模式)
    - [1.3. 常用的RPC框架](#13-常用的rpc框架)
        - [1.3.1. Thrift](#131-thrift)
        - [1.3.2. gRPC](#132-grpc)
    - [1.4. Dubbo](#14-dubbo)
        - [1.4.1. 架构](#141-架构)
        - [1.4.2. 功能](#142-功能)
        - [1.4.3. 连接协议](#143-连接协议)
            - [1.4.3.1. dubbo](#1431-dubbo)
            - [1.4.3.2. rmi](#1432-rmi)
            - [1.4.3.3. hessian](#1433-hessian)
            - [1.4.3.4. http](#1434-http)
            - [1.4.3.5. webservice](#1435-webservice)
            - [1.4.3.6. thrift](#1436-thrift)
            - [1.4.3.7. memcached](#1437-memcached)
            - [1.4.3.8. redis](#1438-redis)
            - [1.4.3.9. rest](#1439-rest)
    - [1.5. 架构演进](#15-架构演进)
    - [1.6. Java 中间件](#16-java-中间件)
    - [1.7. 序列化机制](#17-序列化机制)
        - [1.7.1. 基本概念](#171-基本概念)
        - [1.7.2. 常用序列化方式性能比较](#172-常用序列化方式性能比较)
        - [1.7.3. 常用序列化方式实现](#173-常用序列化方式实现)
            - [1.7.3.1. JDK方式](#1731-jdk方式)
            - [1.7.3.2. FastJSON](#1732-fastjson)
            - [1.7.3.3. Hessian](#1733-hessian)
            - [1.7.3.4. Protostuff](#1734-protostuff)
    - [1.8. 定时任务](#18-定时任务)
    - [1.9. Cron表达式](#19-cron表达式)
        - [1.9.1. Spring Scheduler](#191-spring-scheduler)
        - [1.9.2. Quartz](#192-quartz)
            - [1.9.2.1. Quartz 核心概念](#1921-quartz-核心概念)
    - [1.10. 分布式ID](#110-分布式id)
        - [1.10.1. 应用场景](#1101-应用场景)
        - [1.10.2. 分布式ID生成方案](#1102-分布式id生成方案)
    - [1.11. 分布式锁](#111-分布式锁)
        - [1.11.1. 使用数据库实现](#1111-使用数据库实现)
        - [1.11.2. Redis实现分布式锁](#1112-redis实现分布式锁)
        - [1.11.3. Zookeeper实现分布式锁](#1113-zookeeper实现分布式锁)
    - [1.12. 微服务化](#112-微服务化)
        - [1.12.1. 微服务和SOA](#1121-微服务和soa)
        - [1.12.2. 拆分原则](#1122-拆分原则)
    - [1.13. 消息机制](#113-消息机制)
    - [1.14. 服务降级](#114-服务降级)
    - [1.15. 流量限流](#115-流量限流)
    - [1.16. 幂等设计](#116-幂等设计)
    - [1.17. 数据一致性](#117-数据一致性)
        - [1.17.1. CAP理论](#1171-cap理论)
        - [1.17.2. Base理论](#1172-base理论)
    - [1.18. 分布式事务实现](#118-分布式事务实现)
    - [1.19. 负载均衡算法](#119-负载均衡算法)
    - [1.20. 服务容错设计](#120-服务容错设计)
    - [1.21. 集群](#121-集群)
    - [1.22. 分库分表](#122-分库分表)
    - [1.23. 反向代理&正向代理](#123-反向代理正向代理)
    - [1.24. 客户端优化](#124-客户端优化)
- [1. 浏览器安全](#1-浏览器安全)
    - [1.1. 同源策略](#11-同源策略)
...
* 总结
    ...
    * 一致性hash算法：
        * 可以使消费者始终对应一个服务提供者。缺点是实现相对复杂。同时通过优化hashcode算法和增加虚拟节点解���分布不均的问题。
...
* **架构设计总结**
* 架构的调整是否必须按照上述演变路径进行？
不是的，以上所说的架构演变顺序只是针对某个侧面进行单独的改进，在实际场景中，可能同一时间会有几个���题需要解决，或者可能先达到瓶颈的是另外的方面，这时候就应该按照实际问题实际解决。如在政府类的并发量可能不大，但业务可能很丰富的场景，高并发就不是重点解决的问题，此时优先需要的可能会是丰富需求的解决方案。
