...
- [1. 基础工具](#1-基础工具)
    ...
    - [1.9. 正则表达式](#19-正则表达式)
    - [1.10. 面试考察](#110-面试考察)
        - [1.10.1. 技术广度的考察](#1101-技术广度的考察)
        - [1.10.2. 底层技术的考察](#1102-底层技术的考察)
        - [1.10.3. 技术深度的考察](#1103-技术深度的考察)
...
- [3. Java与面向对象](#3-java与面向对象)
    ...
    - [3.2. 面向对象](#32-面向对象)
        ...
        - [3.2.9. NIO](#329-nio)
            - [3.2.9.1.](#3291)
        - [3.2.10. 类加载和反射](#3210-类加载和反射)
        - [3.2.11. JDBC](#3211-jdbc)
    - [3.3. 函数式编程](#33-函数式编程)
...
- [22. Nginx](#22-nginx)
    - [22.1. 概述](#221-概述)
        - [22.1.1. 功能特性](#2211-功能特性)
        - [22.1.2. Nginx快速理解](#2212-nginx快速理解)
    - [22.2. 基本使用和配置](#222-基本使用和配置)
        - [22.2.1. Nginx平滑升级](#2221-nginx平滑升级)
        - [22.2.2. 配置文件](#2222-配置文件)
    - [22.3. 架构说明](#223-架构说明)
        - [22.3.1. 模块化结构](#2231-模块化结构)
            - [22.3.1.1. 模块分类](#22311-模块分类)
        - [22.3.2. web请求处理机制](#2232-web请求处理机制)
        - [22.3.3. 设计架构概览](#2233-设计架构概览)
    - [22.4. 高级配置](#224-高级配置)
    - [22.5. gzip压缩](#225-gzip压缩)
    - [22.6. rewrite功能](#226-rewrite功能)
        - [22.6.1. nginx后端服务器组的配置的5个技术指令](#2261-nginx后端服务器组的配置的5个技术指令)
        - [22.6.2. rewrite功能的配置](#2262-rewrite功能的配置)
        - [22.6.3. rewrite使用](#2263-rewrite使用)
    - [22.7. 代理服务](#227-代理服务)
        - [22.7.1. 正向代理和反向代理](#2271-正向代理和反向代理)
        - [22.7.2. Nginx正向代理服务](#2272-nginx正向代理服务)
        - [22.7.3. Nginx反向代理服务](#2273-nginx反向代理服务)
            - [22.7.3.1. 反向代理基本设置的21个指令](#22731-反向代理基本设置的21个指令)
            - [22.7.3.2. proxy buffer 的配置的7个指令](#22732-proxy-buffer-的配置的7个指令)
            - [22.7.3.3. proxy cache 的配置的12个指令](#22733-proxy-cache-的配置的12个指令)
        - [22.7.4. Nginx服务器负载均衡](#2274-nginx服务器负载均衡)
    - [22.8. 邮件服务](#228-邮件服务)
    - [22.9. 源码结构](#229-源码结构)
    - [22.10. 基本数据结构](#2210-基本数据结构)
    - [22.11. 启动初始化](#2211-启动初始化)
        - [22.11.1. 启动过程概览](#22111-启动过程概览)
    - [22.12. 时间管理](#2212-时间管理)
    - [22.13. 内存管理](#2213-内存管理)
        - [22.13.1. 内存的逻辑结构](#22131-内存的逻辑结构)
        - [22.13.2. 内存池管理](#22132-内存池管理)
        - [22.13.3. 内存的使用](#22133-内存的使用)
    - [22.14. 工作进程](#2214-工作进程)
        - [22.14.1. nginx服务进程间通信](#22141-nginx服务进程间通信)
            - [22.14.1.1. Linux进程间通信方式](#221411-linux进程间通信方式)
            - [22.14.1.2. Linux进程间双工通信方式的实现](#221412-linux进程间双工通信方式的实现)
            - [22.14.1.3. 通信通道建立和设置](#221413-通信通道建立和设置)
            - [22.14.1.4. 通信通道的使用](#221414-通信通道的使用)
            - [22.14.1.5. 消息的读写](#221415-消息的读写)
    - [22.15. 模块编程](#2215-模块编程)
        - [22.15.1. 模块的种类](#22151-模块的种类)
        - [22.15.2. 模块开发实战](#22152-模块开发实战)
        - [22.15.3. 模块的编译和安装](#22153-模块的编译和安装)
- [23. WEB容器](#23-web容器)
    - [23.1. WEB容器比较](#231-web容器比较)
    - [23.2. SpringBoot WEB相关配置](#232-springboot-web相关配置)
    - [23.3. Tomcat](#233-tomcat)
        - [23.3.1. 概述](#2331-概述)
            - [23.3.1.1. Tomcat快速理解](#23311-tomcat快速理解)
        - [23.3.2. Web服务机制](#2332-web服务机制)
            - [23.3.2.1. 通信协议](#23321-通信协议)
        - [23.3.3. Servlet规范](#2333-servlet规范)
        - [23.3.4. Tomcat 总体架构](#2334-tomcat-总体架构)
        - [23.3.5. Server和Service组件](#2335-server和service组件)
        - [23.3.6. Connect组件](#2336-connect组件)
        - [23.3.7. Engine组件](#2337-engine组件)
        - [23.3.8. Host容器](#2338-host容器)
        - [23.3.9. Context容器](#2339-context容器)
        - [23.3.10. Wrapper容器](#23310-wrapper容器)
        - [23.3.11. 生命周期管理](#23311-生命周期管理)
        - [23.3.12. 日志框架和国家化](#23312-日志框架和国家化)
        - [23.3.13. 公共与隔离类加载器](#23313-公共与隔离类加载器)
        - [23.3.14. 请求URI映射器Mapper](#23314-请求uri映射器mapper)
        - [23.3.15. Tomcat的JNDI](#23315-tomcat的jndi)
        - [23.3.16. 运行、通信、及访问安全管理](#23316-运行通信及访问安全管理)
        - [23.3.17. 处理请求和响应的管道](#23317-处理请求和响应的管道)
        - [23.3.18. 多样化的会话管理器](#23318-多样化的会话管理器)
        - [23.3.19. 高可用集群实现](#23319-高可用集群实现)
        - [23.3.20. 集群通信框架](#23320-集群通信框架)
        - [23.3.21. 监控和管理](#23321-监控和管理)
    - [23.4. Jetty](#234-jetty)
- [24. Java网路通信](#24-java网路通信)
    - [24.1. Java IO 演进之路](#241-java-io-演进之路)
    - [24.2. Java BIO编程](#242-java-bio编程)
    - [24.3. NIO入门](#243-nio入门)
    - [24.4. Netty](#244-netty)
        - [24.4.1. Netty基本案例](#2441-netty基本案例)
        - [24.4.2. TCP粘包拆包](#2442-tcp粘包拆包)
            - [24.4.2.1. 粘包拆包基本概念](#24421-粘包拆包基本概念)
            - [24.4.2.2. LineBasedFrameDecoder方式解决](#24422-linebasedframedecoder方式解决)
            - [24.4.2.3. DelimitBasedFrameDecoder方式解决](#24423-delimitbasedframedecoder方式解决)
            - [24.4.2.4. FixedLengthFrameDecoder方式解决](#24424-fixedlengthframedecoder方式解决)
        - [24.4.3. 私有协议开发](#2443-私有协议开发)
        - [24.4.4. 服务端创建流程分析](#2444-服务端创建流程分析)
        - [24.4.5. 客户端创建流程分析](#2445-客户端创建流程分析)
        - [24.4.6. ByteBuf说明](#2446-bytebuf说明)
        - [24.4.7. Channel和Unsafe](#2447-channel和unsafe)
        - [24.4.8. ChannelPipeline和ChannelHandler](#2448-channelpipeline和channelhandler)
        - [24.4.9. EventLoop和EventLoopGroup](#2449-eventloop和eventloopgroup)
        - [24.4.10. Futur和Promise](#24410-futur和promise)
        - [24.4.11. Netty架构分析](#24411-netty架构分析)
        - [24.4.12. Java多线程编程在Netty中的应用](#24412-java多线程编程在netty中的应用)
        - [24.4.13. 高性能之道](#24413-高性能之道)
        - [24.4.14. 可靠性](#24414-可靠性)
- [25. 消息中间件](#25-消息中间件)
    - [25.1. 消息中间件对比](#251-消息中间件对比)
    - [25.2. 消息队列的作用](#252-消息队列的作用)
    - [25.3. 消息堆积处理](#253-消息堆积处理)
    - [25.4. 消息幂等性](#254-消息幂等性)
    - [25.5. 消息顺序性](#255-消息顺序性)
    - [25.6. JMS,AMQP,MQTT区别与联系](#256-jmsamqpmqtt区别与联系)
        - [25.6.1. Java消息传递服务（Java Messaging Service (JMS)）](#2561-java消息传递服务java-messaging-service-jms)
            - [25.6.1.1. 简介](#25611-简介)
            - [25.6.1.2. 体系架构](#25612-体系架构)
            - [25.6.1.3. JMS对象模型](#25613-jms对象模型)
            - [25.6.1.4. JMS消息模型](#25614-jms消息模型)
            - [25.6.1.5. 接收消息](#25615-接收消息)
            - [25.6.1.6. JMS消息结构（Message）](#25616-jms消息结构message)
        - [25.6.2. 高级消息队列协议（Advanced Message Queueing Protocol (AMQP)）](#2562-高级消息队列协议advanced-message-queueing-protocol-amqp)
            - [25.6.2.1. AMQP 是什么](#25621-amqp-是什么)
            - [25.6.2.2. AMQP模型](#25622-amqp模型)
            - [25.6.2.3. Exchange交换机](#25623-exchange交换机)
            - [25.6.2.4. Queue队列](#25624-queue队列)
            - [25.6.2.5. Consumer消费者](#25625-consumer消费者)
            - [25.6.2.6. 消息机制](#25626-消息机制)
            - [25.6.2.7. 其他](#25627-其他)
        - [25.6.3. 消息队列遥测传输（Message Queueing Telemetry Transport (MQTT)）](#2563-消息队列遥测传输message-queueing-telemetry-transport-mqtt)
            - [25.6.3.1. 简述](#25631-简述)
            - [25.6.3.2. 设计规范](#25632-设计规范)
            - [25.6.3.3. 主要特性](#25633-主要特性)
            - [25.6.3.4. MQTT协议原理](#25634-mqtt协议原理)
            - [25.6.3.5. MQTT协议数据包结构](#25635-mqtt协议数据包结构)
    - [25.7. 面试准备](#257-面试准备)
- [26. Kafka](#26-kafka)
    - [26.1. 概述](#261-概述)
        - [26.1.1. 架构](#2611-架构)
        - [26.1.2. 基本概念](#2612-基本概念)
        - [26.1.3. 快速理解](#2613-快速理解)
    - [26.2. 安装配置](#262-安装配置)
        - [26.2.1. 安装&&启动](#2621-安装启动)
        - [26.2.2. 配置](#2622-配置)
    - [26.3. Kafka生产者](#263-kafka生产者)
        - [26.3.1. 生产者例子](#2631-生产者例子)
        - [26.3.2. 生产者配置](#2632-生产者配置)
        - [26.3.3. 序列化器](#2633-序列化器)
        - [26.3.4. 分区](#2634-分区)
    - [26.4. Kafka消费者](#264-kafka消费者)
        - [26.4.1. 消费者和消费者群组](#2641-消费者和消费者群组)
        - [26.4.2. 消费者实例](#2642-消费者实例)
        - [26.4.3. 消费者配置](#2643-消费者配置)
        - [26.4.4. 提交和偏移量](#2644-提交和偏移量)
            - [26.4.4.1. 自动提交](#26441-自动提交)
            - [26.4.4.2. 提交当前偏移量](#26442-提交当前偏移量)
            - [26.4.4.3. 异步提交](#26443-异步提交)
            - [26.4.4.4. 同步和异步组合提交](#26444-同步和异步组合提交)
            - [26.4.4.5. 提交特定的偏移量](#26445-提交特定的偏移量)
        - [26.4.5. 再均衡监听器](#2645-再均衡监听器)
        - [26.4.6. 从特定偏移量处开始处理](#2646-从特定偏移量处开始处理)
        - [26.4.7. 如何退出](#2647-如何退出)
        - [26.4.8. 独立消费者](#2648-独立消费者)
    - [26.5. 深入Kafka](#265-深入kafka)
        - [26.5.1. 集群成员关系](#2651-集群成员关系)
        - [26.5.2. 控制器](#2652-控制器)
        - [26.5.3. 协调器](#2653-协调器)
        - [26.5.4. 网络通信服务](#2654-网络通信服务)
        - [26.5.5. 日志管理](#2655-日志管理)
            - [26.5.5.1. 日志结构](#26551-日志结构)
            - [26.5.5.2. 日志管理器启动过程](#26552-日志管理器启动过程)
            - [26.5.5.3. 日志加载及恢复](#26553-日志加载及恢复)
            - [26.5.5.4. 日志清理](#26554-日志清理)
        - [26.5.6. 复制](#2656-复制)
        - [26.5.7. 处理请求](#2657-处理请求)
        - [26.5.8. 生产请求](#2658-生产请求)
        - [26.5.9. 获取请求](#2659-获取请求)
        - [26.5.10. 其他请求](#26510-其他请求)
        - [26.5.11. 物理存储](#26511-物理存储)
    - [26.6. 可靠的数据传递](#266-可靠的数据传递)
        - [26.6.1. 可靠性保证](#2661-可靠性保证)
        - [26.6.2. 复制](#2662-复制)
        - [26.6.3. broker配置](#2663-broker配置)
        - [26.6.4. 在可靠的系统里使用生产者](#2664-在可靠的系统里使用生产者)
        - [26.6.5. 在可靠的系统里使用消费者](#2665-在可靠的系统里使用消费者)
        - [26.6.6. 验证系统可靠性](#2666-验证系统可靠性)
    - [26.7. 构建数据管道](#267-构建数据管道)
    - [26.8. 跨越集群数据镜像](#268-跨越集群数据镜像)
        - [26.8.1. 跨集群镜像的使用场景](#2681-跨集群镜像的使用场景)
        - [26.8.2. 多集群架构](#2682-多集群架构)
    - [26.9. 管理Kafaka](#269-管理kafaka)
    - [26.10. 监控Kafka](#2610-监控kafka)
        - [26.10.1. broker的度量指标](#26101-broker的度量指标)
        - [26.10.2. 非同步分区](#26102-非同步分区)
        - [26.10.3. broker度量指标](#26103-broker度量指标)
        - [26.10.4. 主题和分区的度量指标](#26104-主题和分区的度量指标)
        - [26.10.5. Java虚拟机监控](#26105-java虚拟机监控)
        - [26.10.6. 操作系统监控](#26106-操作系统监控)
        - [26.10.7. 日志](#26107-日志)
        - [26.10.8. 客户端监控](#26108-客户端监控)
        - [26.10.9. 生产者度量指标](#26109-生产者度量指标)
        - [26.10.10. 消费者度量指标](#261010-消费者度量指标)
        - [26.10.11. 配额](#261011-配额)
        - [26.10.12. 延迟监控](#261012-延迟监控)
        - [26.10.13. 端到端监控](#261013-端到端监控)
    - [26.11. 流式处理](#2611-流式处理)
        - [26.11.1. 什么是流式处理](#26111-什么是流式处理)
        - [26.11.2. 流式处理的概念](#26112-流式处理的概念)
        - [26.11.3. 使用场景](#26113-使用场景)
        - [26.11.4. 流式处理的设计模式](#26114-流式处理的设计模式)
        - [26.11.5. 实例](#26115-实例)
        - [26.11.6. 架构概览](#26116-架构概览)
        - [26.11.7. 如何选择流式处理框架](#26117-如何选择流式处理框架)
...
- [29. FastDfs](#29-fastdfs)
    - [29.1. 为什么要使用分布式文件系统](#291-为什么要使用分布式文件系统)
        - [29.1.1. 单机时代](#2911-单机时代)
        - [29.1.2. 独立文件服务器](#2912-独立文件服务器)
        - [29.1.3. 分布式文件系统](#2913-分布式文件系统)
    - [29.2. 基本概念](#292-基本概念)
        - [29.2.1. 什么是FastDFS](#2921-什么是fastdfs)
    - [29.3. 工作流程](#293-工作流程)
        - [29.3.1. 文件上传](#2931-文件上传)
        - [29.3.2. 文件下载](#2932-文件下载)
    - [29.4. FastDFS为什么要结合Nginx](#294-fastdfs为什么要结合nginx)
    - [29.5. 配置文件说明](#295-配置文件说明)
    - [29.6. FastDFS 同步机制说明：](#296-fastdfs-同步机制说明)
    - [29.7. 安装配置](#297-安装配置)
    - [29.8. Java客户端使用](#298-java客户端使用)
- [30. 性能调优](#30-性能调优)
...
- [31. Elasticsearch搜索引擎](#31-elasticsearch搜索引擎)
    - [31.1. 基本概念](#311-基本概念)
    - [31.2. Elasticsearch工作流程](#312-elasticsearch工作流程)
        - [31.2.1. 启动过程](#3121-启动过程)
        - [31.2.2. 故障检测](#3122-故障检测)
        - [31.2.3. 与El通信](#3123-与el通信)
            - [31.2.3.1. 索引数据](#31231-索引数据)
            - [31.2.3.2. 查询数据](#31232-查询数据)
    - [31.3. 安装与配置](#313-安装与配置)
        - [31.3.1. 配置文件说明](#3131-配置文件说明)
            - [31.3.1.1. elasticsearch.yml](#31311-elasticsearchyml)
    - [31.4. 索引](#314-索引)
        - [31.4.1. 索引](#3141-索引)
        - [31.4.2. 映射配置](#3142-映射配置)
    - [31.5. 集群管理](#315-集群管理)
        - [31.5.1. 集群健康](#3151-集群健康)
        - [31.5.2. 添加索引](#3152-添加索引)
    - [31.6. 数据](#316-数据)
        - [31.6.1. 文档](#3161-文档)
        - [31.6.2. 处理冲突](#3162-处理冲突)
    - [31.7. 分布式增删改查](#317-分布式增删改查)
        - [31.7.1. 路由文档到分片](#3171-路由文档到分片)
        - [31.7.2. 分片交互](#3172-分片交互)
            - [31.7.2.1. 新建，索引和删除文档](#31721-新建索引和删除文档)
            - [31.7.2.2. 索引文档](#31722-索引文档)
    - [31.8. 面试小结之Elasticsearch篇](#318-面试小结之elasticsearch篇)
- [32. 概述](#32-概述)
...
#### 22.7.3.2. proxy buffer 的配置的7个指令
<a href="#menu" style="float:right">目录</a>
...
#### 22.7.3.3. proxy cache 的配置的12个指令
<a href="#menu" style="float:right">目录</a>
...
### 22.14.1. nginx服务进程间通信
<a href="#menu" style="float:right">目录</a>

#### 22.14.1.1. Linux进程间通信方式
...
#### 24.4.2.2. LineBasedFrameDecoder方式解决
<a href="#menu" style="float:right">目录</a>

#### 24.4.2.3. DelimitBasedFrameDecoder方式解决
<a href="#menu" style="float:right">目录</a>


#### 24.4.2.4. FixedLengthFrameDecoder方式解决
<a href="#menu" style="float:right">目录</a>
...
### 24.4.7. Channel和Unsafe

### 24.4.8. ChannelPipeline和ChannelHandler

### 24.4.9. EventLoop和EventLoopGroup

### 24.4.10. Futur和Promise

### 24.4.11. Netty架构分析

### 24.4.12. Java多线程编程在Netty中的应用
...
### 25.6.1. Java消息传递服务（Java Messaging Service (JMS)）
...
### 25.6.2. 高级消息队列协议（Advanced Message Queueing Protocol (AMQP)）
<a href="#menu" style="float:right">目录</a>
...
### 25.6.3. 消息队列遥测传输（Message Queueing Telemetry Transport (MQTT)）
<a href="#menu" style="float:right">目录</a>
