...
- [1. Java与面向对象](#1-java与面向对象)
    ...
    - [1.2. 面向对象](#12-面向对象)
        ...
        - [1.2.7. IO](#127-io)
        - [1.2.8. File](#128-file)
            - [1.2.8.1. IO流](#1281-io流)
            - [1.2.8.2. 序列化](#1282-序列化)
        - [NIO](#nio)
            - [](#)
        - [1.2.9. 类加载和反射](#129-类加载和反射)
        - [1.2.10. JDBC](#1210-jdbc)
    - [1.3. 函数式编程](#13-函数式编程)
    - [1.4. Java 8 的新特性：](#14-java-8-的新特性)
        - [1.4.1. Java 8 Lambda 表达式](#141-java-8-lambda-表达式)
        - [1.4.2. Java 8 函数式接口](#142-java-8-函数式接口)
        - [1.4.3. 默认方法](#143-默认方法)
        - [1.4.4. Optional 类](#144-optional-类)
        - [1.4.5. Stream](#145-stream)
        - [1.4.6. Java 8 日期时间 API](#146-java-8-日期时间-api)
        - [1.4.7. Java8 Base64](#147-java8-base64)
    - [1.5. JDK版本变化](#15-jdk版本变化)
    - [1.6. 设计模式](#16-设计模式)
        - [1.6.1. 设计原则](#161-设计原则)
            - [1.6.1.1. 单一职责原则](#1611-单一职责原则)
            - [1.6.1.2. 里氏替换原则](#1612-里氏替换原则)
            - [1.6.1.3. 依赖倒置原则](#1613-依赖倒置原则)
            - [1.6.1.4. 接口隔离原则](#1614-接口隔离原则)
            - [1.6.1.5. 迪米特法则](#1615-迪米特法则)
            - [1.6.1.6. 开闭原则](#1616-开闭原则)
        - [1.6.2. UML图](#162-uml图)
        - [1.6.3. 单例模式](#163-单例模式)
            - [1.6.3.1. 基本概念](#1631-基本概念)
            - [1.6.3.2. 实现](#1632-实现)
        - [1.6.4. 工厂方法模式](#164-工厂方法模式)
        - [1.6.5. 抽象工厂模式](#165-抽象工厂模式)
        - [1.6.6. 模板方法模式](#166-模板方法模式)
        - [1.6.7. 建造者模式](#167-建造者模式)
        - [1.6.8. 代理模式](#168-代理模式)
        - [1.6.9. 原型模式](#169-原型模式)
        - [1.6.10. 中介者模式](#1610-中介者模式)
        - [1.6.11. 命令模式](#1611-命令模式)
        - [1.6.12. 责任链模式](#1612-责任链模式)
        - [1.6.13. 装饰模式](#1613-装饰模式)
        - [1.6.14. 策略模式](#1614-策略模式)
        - [1.6.15. 适配器模式](#1615-适配器模式)
        - [1.6.16. 迭代器模式](#1616-迭代器模式)
        - [1.6.17. 组合模式](#1617-组合模式)
        - [1.6.18. 观察者模式](#1618-观察者模式)
        - [1.6.19. 门面模式](#1619-门面模式)
        - [1.6.20. 备忘录模式](#1620-备忘录模式)
        - [1.6.21. 访问者模式](#1621-访问者模式)
        - [1.6.22. 状态模式](#1622-状态模式)
        - [1.6.23. 解释器模式](#1623-解释器模式)
        - [1.6.24. 享元模式](#1624-享元模式)
        - [1.6.25. 桥梁模式](#1625-桥梁模式)
- [1. 基本概念](#1-基本概念)
- [2. Java多线程](#2-java多线程)
    - [2.1. 实现方式](#21-实现方式)
    - [2.2. 基本属性](#22-基本属性)
...
- [6. 登录认证](#6-登录认证)
    ...
    - [6.3. token<span id="menu"></span>](#63-tokenspan-idmenuspan)
- [1. MySQL](#1-mysql)
    - [1.1. 基本概念](#11-基本概念)
        - [1.1.1. 基本概念](#111-基本概念)
        - [1.1.2. 常用工具](#112-常用工具)
    ...
    - [1.17. 分库分表](#117-分库分表)
        ...
        - [1.17.2. 分布式事务](#1172-分布式事务)
        - [1.17.3. 应对多机数据查询](#1173-应对多机数据查询)
            - [1.17.3.1. 跨库Join](#11731-跨库join)
            - [1.17.3.2. 外键约束](#11732-外键约束)
    - [1.18. 高可用](#118-高可用)
...
- [1. Java网路通信](#1-java网路通信)
    ...
    - [1.2. Java BIO编程](#12-java-bio编程)
    - [1.3. NIO入门](#13-nio入门)
    - [1.4. Netty](#14-netty)
        - [1.4.1. Netty基本案例](#141-netty基本案例)
        - [1.4.2. TCP粘包拆包](#142-tcp粘包拆包)
            - [1.4.2.1. 粘包拆包基本概念](#1421-粘包拆包基本概念)
            - [1.4.2.2. LineBasedFrameDecoder方式解决](#1422-linebasedframedecoder方式解决)
            - [1.4.2.3. DelimitBasedFrameDecoder方式解决](#1423-delimitbasedframedecoder方式解决)
            - [1.4.2.4. FixedLengthFrameDecoder方式解决](#1424-fixedlengthframedecoder方式解决)
        - [1.4.3. 私有协议开发](#143-私有协议开发)
        - [1.4.4. 服务端创建流程分析](#144-服务端创建流程分析)
        - [1.4.5. 客户端创建流程分析](#145-客户端创建流程分析)
        - [1.4.6. ByteBuf说明](#146-bytebuf说明)
        - [1.4.7. Channel和Unsafe](#147-channel和unsafe)
        - [1.4.8. ChannelPipeline和ChannelHandler](#148-channelpipeline和channelhandler)
        - [1.4.9. EventLoop和EventLoopGroup](#149-eventloop和eventloopgroup)
        - [1.4.10. Futur和Promise](#1410-futur和promise)
        - [1.4.11. Netty架构分析](#1411-netty架构分析)
        - [1.4.12. Java多线程编程在Netty中的应用](#1412-java多线程编程在netty中的应用)
        - [1.4.13. 高性能之道](#1413-高性能之道)
        - [1.4.14. 可靠性](#1414-可靠性)
- [1. 消息中间件](#1-消息中间件)
