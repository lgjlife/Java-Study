...
- [1. WEB容器](#1-web容器)
    ...
    - [1.2. SpringBoot WEB相关配置](#12-springboot-web相关配置)
    - [1.3. Tomcat](#13-tomcat)
        - [1.3.1. 概述](#131-概述)
            - [1.3.1.1. Tomcat快速理解](#1311-tomcat快速理解)
        - [1.3.2. Web服务机制](#132-web服务机制)
            - [1.3.2.1. 通信协议](#1321-通信协议)
        - [1.3.3. Servlet规范](#133-servlet规范)
        - [1.3.4. Tomcat 总体架构](#134-tomcat-总体架构)
        - [1.3.5. Server和Service组件](#135-server和service组件)
        - [1.3.6. Connect组件](#136-connect组件)
        - [1.3.7. Engine组件](#137-engine组件)
        - [1.3.8. Host容器](#138-host容器)
        - [1.3.9. Context容器](#139-context容器)
        - [1.3.10. Wrapper容器](#1310-wrapper容器)
        - [1.3.11. 生命周期管理](#1311-生命周期管理)
        - [1.3.12. 日志框架和国家化](#1312-日志框架和国家化)
        - [1.3.13. 公共与隔离类加载器](#1313-公共与隔离类加载器)
        - [1.3.14. 请求URI映射器Mapper](#1314-请求uri映射器mapper)
        - [1.3.15. Tomcat的JNDI](#1315-tomcat的jndi)
        - [1.3.16. 运行、通信、及访问安全管理](#1316-运行通信及访问安全管理)
        - [1.3.17. 处理请求和响应的管道](#1317-处理请求和响应的管道)
        - [1.3.18. 多样化的会话管理器](#1318-多样化的会话管理器)
        - [1.3.19. 高可用集群实现](#1319-高可用集群实现)
        - [1.3.20. 集群通信框架](#1320-集群通信框架)
        - [1.3.21. 监控和管理](#1321-监控和管理)
    - [1.4. Jetty](#14-jetty)
