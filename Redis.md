...
- [1. Redis](#1-redis)
    ...
    - [1.2. 常用数据结构](#12-常用数据结构)
        ...
        - [1.2.7. 事务](#127-事务)
        - [1.2.8. 键](#128-键)
            - [1.2.8.1. SCAN](#1281-scan)
                - [1.2.8.1.1. 基本用法](#12811-基本用法)
                - [1.2.8.1.2. SCAN命令的保证](#12812-scan命令的保证)
                - [1.2.8.1.3. 每次执行返回的元素](#12813-每次执行返回的元素)
                - [1.2.8.1.4. COUNT选项](#12814-count选项)
                - [1.2.8.1.5. MATCH 选项](#12815-match-选项)
                - [1.2.8.1.6. 并发执行多个迭代](#12816-并发执行多个迭代)
                - [1.2.8.1.7. 中途停止迭代](#12817-中途停止迭代)
                - [1.2.8.1.8. 使用错误的游标进行增量式迭代](#12818-使用错误的游标进行增量式迭代)
                - [1.2.8.1.9. 迭代终结的保证](#12819-迭代终结的保证)
            - [1.2.8.2. SORT](#1282-sort)
                - [1.2.8.2.1. 一般SORT的用法](#12821-一般sort的用法)
                - [1.2.8.2.2. 使用ALPHA](#12822-使用alpha)
                - [1.2.8.2.3. 使用LIMIT](#12823-使用limit)
                - [1.2.8.2.4. 使用外部KEY](#12824-使用外部key)
                - [1.2.8.2.5. 保存排序结果](#12825-保存排序结果)
        - [1.2.9. 连接](#129-连接)
        - [1.2.10. Server（服务器）](#1210-server服务器)
    ...
    - [1.12. 线程模型](#112-线程模型)
    - [1.13. 慢查询日志](#113-慢查询日志)
    - [1.14. 监视器](#114-监视器)
    - [1.15. 关于redis性能问题分析和优化](#115-关于redis性能问题分析和优化)
        - [1.15.1. 如何查看Redis性能](#1151-如何查看redis性能)
        - [1.15.2. 内存](#1152-内存)
        - [1.15.3. 命令处理数](#1153-命令处理数)
        - [1.15.4. 延迟时间](#1154-延迟时间)
        - [1.15.5. 内存碎片率](#1155-内存碎片率)
        - [1.15.6. 回收key](#1156-回收key)
