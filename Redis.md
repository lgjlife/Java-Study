...
- [1. Redis](#1-redis)
    - [1.1. 数据结构和对象](#11-数据结构和对象)
        - [1.1.1. 简单动态字符串](#111-简单动态字符串)
        - [1.1.2. 链表](#112-链表)
        - [1.1.3. 字典](#113-字典)
            - [1.1.3.1. Rehash](#1131-rehash)
        - [1.1.4. 跳跃表](#114-跳跃表)
        - [1.1.5. 整数集合](#115-整数集合)
        - [1.1.6. 压缩列表](#116-压缩列表)
        - [1.1.7. 对象](#117-对象)
            - [1.1.7.1. 对象类型和编码](#1171-对象类型和编码)
            - [1.1.7.2. 字符串对象](#1172-字符串对象)
            - [1.1.7.3. 列表对象](#1173-列表对象)
            - [1.1.7.4. 哈希对象](#1174-哈希对象)
            - [1.1.7.5. 集合对象](#1175-集合对象)
            - [1.1.7.6. 由于集合对象](#1176-由于集合对象)
            - [1.1.7.7. 类型检查和命令多态](#1177-类型检查和命令多态)
            - [1.1.7.8. 内存回收](#1178-内存回收)
            - [1.1.7.9. 对象共享](#1179-对象共享)
            - [1.1.7.10. 对象空转时长](#11710-对象空转时长)
    - [1.2. 单机数据库实现](#12-单机数据库实现)
        - [1.2.1. 数据库](#121-数据库)
        ...
        - [1.2.5. 客户端](#125-客户端)
        - [1.2.6. 服务器](#126-服务器)
    - [1.3. 多机数据库实现](#13-多机数据库实现)
        - [1.3.1. 复制](#131-复制)
        - [1.3.2. 哨兵](#132-哨兵)
        - [1.3.3. 集群](#133-集群)
    - [1.4. 独立功能实现](#14-独立功能实现)
        - [1.4.1. 发布与订阅](#141-发布与订阅)
        - [1.4.2. 事务](#142-事务)
        - [1.4.3. LUA脚本](#143-lua脚本)
        - [1.4.4. 排序](#144-排序)
        - [1.4.5. 二进制位数组](#145-二进制位数组)
        - [1.4.6. 慢查询日志](#146-慢查询日志)
        - [1.4.7. 监视器](#147-监视器)
