...
- [16. 设计模式](#16-设计模式)
    ...
    - [16.4. 设计模式](#164-设计模式)
        ...
        - [16.4.10. 中介者模式](#16410-中介者模式)
        - [16.4.11. 命令模式](#16411-命令模式)
        - [16.4.12. 责任链模式](#16412-责任链模式)
        - [16.4.13. 装饰模式](#16413-装饰模式)
        - [16.4.14. 策略模式](#16414-策略模式)
        - [16.4.15. 适配器模式](#16415-适配器模式)
        - [16.4.16. 迭代器模式](#16416-迭代器模式)
        - [16.4.17. 组合模式](#16417-组合模式)
        - [16.4.18. 观察者模式](#16418-观察者模式)
        - [16.4.19. 门面模式](#16419-门面模式)
        - [16.4.20. 备忘录模式](#16420-备忘录模式)
        - [16.4.21. 访问者模式](#16421-访问者模式)
        - [16.4.22. 状态模式](#16422-状态模式)
        - [16.4.23. 解释器模式](#16423-解释器模式)
        - [16.4.24. 享元模式](#16424-享元模式)
        - [16.4.25. 桥梁模式](#16425-桥梁模式)
    - [16.5. 设计模式对比](#165-设计模式对比)
        - [16.5.1. 适配器与桥接模式](#1651-适配器与桥接模式)
        - [16.5.2. 适配器与装饰模式](#1652-适配器与装饰模式)
        - [16.5.3. 适配器与代理模式](#1653-适配器与代理模式)
