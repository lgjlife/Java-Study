...
- [17. Effect Java](#17-effect-java)
  - [17.1. 创建和销毁对象](#171-创建和销毁对象)
  - [17.2. 对于所有对象都通用的方法](#172-对于所有对象都通用的方法)
  - [17.3. 类和接口](#173-类和接口)
  - [17.4. 范型](#174-范型)
  - [17.5. 枚举和注解](#175-枚举和注解)
  - [17.6. Lambda和Stream](#176-lambda和stream)
  - [17.7. 方法](#177-方法)
  - [17.8. 通用编程](#178-通用编程)
  - [17.9. 异常](#179-异常)
  - [17.10. 并发](#1710-并发)
...
- [18. 设计模式](#18-设计模式)
  ...
  - [18.3. UML图](#183-uml图)
    ...
    - [18.3.5. 顺序图](#1835-顺序图)
    - [18.3.6. 活动图](#1836-活动图)
    - [18.3.7. 状态机图](#1837-状态机图)
  - [设计模式在框架中的应用](#设计模式在框架中的应用)
  - [18.4. 设计模式](#184-设计模式)
    - [18.4.1. 单例模式](#1841-单例模式)
      - [18.4.1.1. 基本概念](#18411-基本概念)
      - [18.4.1.2. 实现](#18412-实现)
    - [18.4.2. 简单工厂模式](#1842-简单工厂模式)
    - [18.4.3. 工厂方法模式](#1843-工厂方法模式)
    - [18.4.4. 抽象工厂模式](#1844-抽象工厂模式)
    - [18.4.5. 简单工厂&抽象工厂&工厂方法比较](#1845-简单工厂抽象工厂工厂方法比较)
    - [18.4.6. 模板方法模式](#1846-模板方法模式)
    - [18.4.7. 建造者模式](#1847-建造者模式)
    - [18.4.8. 代理模式](#1848-代理模式)
    - [18.4.9. 原型模式](#1849-原型模式)
    - [18.4.10. 中介者模式](#18410-中介者模式)
    - [18.4.11. 命令模式](#18411-命令模式)
    - [18.4.12. 责任链模式](#18412-责任链模式)
    - [18.4.13. 装饰模式](#18413-装饰模式)
    - [18.4.14. 策略模式](#18414-策略模式)
    - [18.4.15. 适配器模式](#18415-适配器模式)
    - [18.4.16. 迭代器模式](#18416-迭代器模式)
    - [18.4.17. 组合模式](#18417-组合模式)
    - [18.4.18. 观察者模式](#18418-观察者模式)
    - [18.4.19. 门面模式](#18419-门面模式)
    - [18.4.20. 备忘录模式](#18420-备忘录模式)
    - [18.4.21. 访问者模式](#18421-访问者模式)
    - [18.4.22. 状态模式](#18422-状态模式)
    - [18.4.23. 解释器模式](#18423-解释器模式)
    - [18.4.24. 享元模式](#18424-享元模式)
    - [18.4.25. 桥梁模式](#18425-桥梁模式)
  - [18.5. 设计模式对比](#185-设计模式对比)
    - [18.5.1. 适配器与桥接模式](#1851-适配器与桥接模式)
    - [18.5.2. 适配器与装饰模式](#1852-适配器与装饰模式)
    - [18.5.3. 适配器与代理模式](#1853-适配器与代理模式)
    - [18.5.4. 中介者和外观模式](#1854-中介者和外观模式)
