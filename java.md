...
- [5. 设计模式](#5-设计模式)
    - [5.1. 设计原则](#51-设计原则)
        - [5.1.1. 单一职责原则](#511-单一职责原则)
        - [5.1.2. 里氏替换原则](#512-里氏替换原则)
        - [5.1.3. 依赖倒置原则](#513-依赖倒置原则)
        - [5.1.4. 接口隔离原则](#514-接口隔离原则)
        - [5.1.5. 迪米特法则](#515-迪米特法则)
        - [5.1.6. 开闭原则](#516-开闭原则)
    - [5.2. UML图](#52-uml图)
    - [5.3. 单例模式](#53-单例模式)
        - [5.3.1. 基本概念](#531-基本概念)
        - [5.3.2. 实现](#532-实现)
    - [5.4. 工厂方法模式](#54-工厂方法模式)
    - [5.5. 抽象工厂模式](#55-抽象工厂模式)
    - [5.6. 模板方法模式](#56-模板方法模式)
    - [5.7. 建造者模式](#57-建造者模式)
    - [5.8. 代理模式](#58-代理模式)
    - [5.9. 原型模式](#59-原型模式)
    - [5.10. 中介者模式](#510-中介者模式)
    - [5.11. 命令模式](#511-命令模式)
    - [5.12. 责任链模式](#512-责任链模式)
    - [5.13. 装饰模式](#513-装饰模式)
    - [5.14. 策略模式](#514-策略模式)
    - [5.15. 适配器模式](#515-适配器模式)
    - [5.16. 迭代器模式](#516-迭代器模式)
    - [5.17. 组合模式](#517-组合模式)
    - [5.18. 观察者模式](#518-观察者模式)
    - [5.19. 门面模式](#519-门面模式)
    - [5.20. 备忘录模式](#520-备忘录模式)
    - [5.21. 访问者模式](#521-访问者模式)
    - [5.22. 状态模式](#522-状态模式)
    - [5.23. 解释器模式](#523-解释器模式)
    - [5.24. 享元模式](#524-享元模式)
    - [5.25. 桥梁模式](#525-桥梁模式)
