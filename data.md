...
- [1. MySQL](#1-mysql)
    ...
    - [1.11. 触发器](#111-触发器)
    - [1.12. 高可用](#112-高可用)
        - [1.12.1. 主从复制](#1121-主从复制)
            - [1.12.1.1. 常见形式](#11211-常见形式)
            - [1.12.1.2. 主从同步复制原理](#11212-主从同步复制原理)
            - [1.12.1.3. 主从同步配置](#11213-主从同步配置)
            - [添加更多从服务器](#添加更多从服务器)
- [2. MyBatis](#2-mybatis)
- [3. Netty](#3-netty)
- [4. Dubbo](#4-dubbo)
- [5. Redis](#5-redis)
    - [5.1. 基本概念](#51-基本概念)
    - [5.2. 应用场景](#52-应用场景)
    - [5.3. 与memcache比较](#53-与memcache比较)
    - [5.4. 启动](#54-启动)
    - [5.5. 配置说明](#55-配置说明)
    - [5.6. 基本类型 & 常用命令](#56-基本类型--常用命令)
        - [5.6.1. 字符串类型String](#561-字符串类型string)
        - [5.6.2. 散列类型Hash](#562-散列类型hash)
        - [5.6.3. 列表类型List](#563-列表类型list)
        - [5.6.4. 集合类型set](#564-集合类型set)
        - [5.6.5. 有序集合类型zset](#565-有序集合类型zset)
        - [5.6.6. 常用命令](#566-常用命令)
    - [5.7. 其他功能](#57-其他功能)
        - [5.7.1. 事务](#571-事务)
        - [5.7.2. 过期时间](#572-过期时间)
    ...
    - [5.8. LUA脚本](#58-lua脚本)
        - [5.8.1. 基本概念](#581-基本概念)
        - [5.8.2. LUA语法](#582-lua语法)
        - [5.8.3. Redis与LUA](#583-redis与lua)
        - [5.8.4. Jedis使用](#584-jedis使用)
    - [5.9. 复制持久化原理](#59-复制持久化原理)
    - [5.10. 高可用模式](#510-高可用模式)
        - [5.10.1. 主从模式](#5101-主从模式)
        - [5.10.2. 哨兵模式](#5102-哨兵模式)
        - [5.10.3. 集群模式](#5103-集群模式)
    - [5.11. 数据类型底层实现](#511-数据类型底层实现)
    - [5.12. 常用Java客户端](#512-常用java客户端)
        - [5.12.1. Jedis](#5121-jedis)
        - [5.12.2. Redission](#5122-redission)
        - [5.12.3. Redlock](#5123-redlock)
    - [5.13. 缓存一致性解决](#513-缓存一致性解决)
    - [5.14. 缓存雪崩，击穿等处理](#514-缓存雪崩击穿等处理)
- [6. Elasticsearch搜索引擎](#6-elasticsearch搜索引擎)
    - [6.1. 基本概念](#61-基本概念)
    - [6.2. 配置文件说明](#62-配置文件说明)
        - [6.2.1. elasticsearch.yml](#621-elasticsearchyml)
    - [6.3. 索引](#63-索引)
        - [6.3.1. 索引](#631-索引)
    - [6.4. 搜索](#64-搜索)
    - [6.5. 扩展索引结构](#65-扩展索引结构)
    - [6.6. 更好的搜索](#66-更好的搜索)
    - [6.7. 超越全文索引](#67-超越全文索引)
    - [6.8. 深入集群](#68-深入集群)
    - [6.9. 集群管理](#69-集群管理)
