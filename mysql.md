...
- [1. MySQL](#1-mysql)
    ...
    - [1.2. 日志文件](#12-日志文件)
        - [1.2.1. 参数文件](#121-参数文件)
        - [1.2.2. 日志文件](#122-日志文件)
        - [1.2.3. socket文件](#123-socket文件)
        - [1.2.4. pid文件](#124-pid文件)
        - [1.2.5. MySQL表结构文件](#125-mysql表结构文件)
        - [1.2.6. 存储引擎文件](#126-存储引擎文件)
    - [1.3. NoSQL与关系型数据库设计理念比较](#13-nosql与关系型数据库设计理念比较)
        - [1.3.1. 关系型数据库](#131-关系型数据库)
        - [1.3.2. 非关系型数据库](#132-非关系型数据库)
    - [1.4. 使用数据库](#14-使用数据库)
    - [1.5. 数据类型](#15-数据类型)
    - [1.6. 数据更新](#16-数据更新)
    - [1.7. 查询入门](#17-查询入门)
    - [1.8. 多表连接查询](#18-多表连接查询)
    - [1.9. 函数](#19-函数)
        - [1.9.1. 聚集函数](#191-聚集函数)
        - [1.9.2. 数学函数](#192-数学函数)
        - [1.9.3. 字符串函数](#193-字符串函数)
        - [1.9.4. 日期和时间函数](#194-日期和时间函数)
        - [1.9.5. 条件判断函数](#195-条件判断函数)
        - [1.9.6. 系统信息函数](#196-系统信息函数)
        - [1.9.7. 加密函数](#197-加密函数)
        - [1.9.8. 其他函数](#198-其他函数)
    - [1.10. 存储过程](#110-存储过程)
    ...
    - [1.14. 数据库索引](#114-数据库索引)
        - [1.14.1. 基本概念](#1141-基本概念)
            - [1.14.1.1. 分类](#11411-分类)
            - [1.14.1.2. 索引用途](#11412-索引用途)
            - [1.14.1.3. 索引的误区](#11413-索引的误区)
            - [1.14.1.4. 索引数据结构](#11414-索引数据结构)
    - [1.15. 存储引擎](#115-存储引擎)
        - [1.15.1. InnoDB存储引擎](#1151-innodb存储引擎)
        - [1.15.2. MyISAM存储引擎](#1152-myisam存储引擎)
        - [1.15.3. MEMORY存储引擎](#1153-memory存储引擎)
        - [1.15.4. 存储引擎的选择](#1154-存储引擎的选择)
    - [1.16. 性能优化基本的分析命令](#116-性能优化基本的分析命令)
        - [1.16.1. explain](#1161-explain)
        - [1.16.2. show indexs](#1162-show-indexs)
    - [1.17. 分库分表](#117-分库分表)
        - [基本概念](#基本概念)
    - [1.18. 高可用](#118-高可用)
        - [1.18.1. 主从复制](#1181-主从复制)
            - [1.18.1.1. 常见形式](#11811-常见形式)
            - [1.18.1.2. 主从同步复制原理](#11812-主从同步复制原理)
            - [1.18.1.3. 主从同步配置](#11813-主从同步配置)
            - [1.18.1.4. 添加更多从服务器](#11814-添加更多从服务器)
...
* 数据拆分
    ...
    * 水平拆分
        ...
        * 问题
            ...
            * 针对单个表的逻辑查询可能要跨库
    * 解决方法
        * 使用数据库中间件，比如MyCAT,sharding-jdbc
